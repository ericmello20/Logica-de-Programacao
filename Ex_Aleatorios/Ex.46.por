...
8. Leia uma matriz de 3 x 3 elementos. Calcule a soma dos elementos que estao acima da diagonal principal.
	...
	funcao inteiro soma_elementos(inteiro m[][]){
		...
		para(inteiro i = 0; i < max; i++){
			para(inteiro j = 0; j < max; j++){
				se(i < j){ // para somar só os elementos acima, o índice de j sempre terá q ser MAIOR doq o índice de i.
					soma += m[i][j]
				}
			}
		}
